                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="rfc_solicitante" class="block w-full uppercase text-sm border-slate-300 focus:border-blue-900 focus:ring-blue-900 rounded-sm shadow-sm bg-slate-50" type="text" name="rfc_solicitante" 
                                        :value="old('rfc_solicitante', $manifestation->rfc_solicitante ?? '')" required minlength="12" maxlength="13" />
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <input id="rfc_importador" class="block w-full text-sm border-slate-300 focus:border-blue-900 focus:ring-blue-900 rounded-sm shadow-sm bg-slate-50 uppercase" type="text" name="rfc_importador" x-model="form.rfc_importador" @input="buscarRazonSocial()" required minlength="12" maxlength="13" />
            ...
            return {
                ...
                buscarRazonSocial() {
                    ...
                    if (rfc.length >= 12 && rfc.length <= 13) {
                        this.mensajeAyuda = 'RFC válido (' + (rfc.length === 12 ? 'Persona Moral' : 'Persona Física') + ').';
                    } else {
                        this.mensajeAyuda = 'Escribiendo... (12 o 13 caracteres)';
                    }
                }
            }
        }
