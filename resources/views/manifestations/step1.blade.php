                    ...
                    <form method="POST" action="{{ route('manifestations.store') }}">
                        ...
                        @if ($errors->any())
                            <div class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded shadow-sm">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-red-800">Existen errores en el formulario</h3>
                        ...
                        <div class="bg-slate-50 p-6 rounded-lg mb-8 border border-slate-200 relative">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-6">
                                <div>
                                    <x-input-label for="curp_solicitante" :value="__('CURP')" class="font-bold text-slate-700 required" />
                                    ...
                                    <x-input-error :messages="$errors->get('curp_solicitante')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="rfc_solicitante" :value="__('RFC')" class="font-bold text-slate-700 required" />
                                    ...
                                    <x-input-error :messages="$errors->get('rfc_solicitante')" class="mt-2" />
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <x-input-label for="nombre" :value="__('Nombre(s)')" class="text-slate-600 required" />
                                    <x-text-input id="nombre" class="block mt-1 w-full border-slate-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="nombre" :value="old('nombre')" required />
                                    <x-input-error :messages="$errors->get('nombre')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="apellido_paterno" :value="__('Apellido Paterno')" class="text-slate-600 required" />
                                    <x-text-input id="apellido_paterno" class="block mt-1 w-full border-slate-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="apellido_paterno" :value="old('apellido_paterno')" required />
                                    <x-input-error :messages="$errors->get('apellido_paterno')" class="mt-2" />
                                </div>
                                <div>
                                    <!-- APELLIDO MATERNO AHORA OBLIGATORIO -->
                                    <x-input-label for="apellido_materno" :value="__('Apellido Materno')" class="text-slate-600 required" />
                                    <x-text-input id="apellido_materno" class="block mt-1 w-full border-slate-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="apellido_materno" :value="old('apellido_materno')" required />
                        ...
                        <div class="bg-blue-50 p-6 rounded-lg mb-8 border border-blue-100 relative">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-6">
                                <div>
                                    <x-input-label for="rfc_importador" :value="__('RFC Importador')" class="font-bold text-blue-900 required" />
                                    ...
                                    <x-input-error :messages="$errors->get('rfc_importador')" class="mt-2" />
                                ...
                                <div>
                                    <x-input-label for="razon_social_importador" :value="__('Razón Social')" class="font-bold text-blue-900 required" />
                                    ...
                                    <x-input-error :messages="$errors->get('razon_social_importador')" class="mt-2" />
                                </div>
                                <div class="md:col-span-2">
                                    <x-input-label for="registro_nacional_contribuyentes" :value="__('Registro Nacional de Contribuyentes')" class="text-blue-900 required" />
                                    <input id="registro_nacional_contribuyentes" class="block mt-1 w-full bg-slate-100 text-slate-500 cursor-not-allowed border-slate-300 rounded-md shadow-sm" type="text" name="registro_nacional_contribuyentes" x-model="form.registro_nacional" readonly required />
                                </div>
                            </div>
                        </div>
