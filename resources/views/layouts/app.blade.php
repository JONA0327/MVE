...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-gray-50">
    <head>
        ...
        <title>{{ config('app.name', 'E&I Comercio Exterior') }}</title>
    ...
    <body class="font-sans antialiased h-full text-slate-800">
        <div class="min-h-screen bg-gray-50">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="ml-3 relative">
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-600 hover:text-blue-900 hover:bg-gray-50 focus:outline-none transition ease-in-out duration-150">
                                            <div class="flex flex-col items-end mr-2">
                                                <span class="font-bold">{{ Auth::user()->name }}</span>
                                                <span class="text-xs text-slate-400 font-mono">{{ Auth::user()->rfc }}</span>
                                            </div>
                                            <div class="ml-1">
            ...
            <div class="pt-20">
                ...
                <footer class="bg-slate-50 border-t border-gray-200 mt-12 py-8">
                    <div class="max-w-7xl mx-auto px-4 text-center">
                        <p class="text-xs text-slate-400">
                            &copy; {{ date('Y') }} E&I Comercio Exterior, Logística y Tecnología. <br>Todos los derechos reservados.
                        </p>
                    </div>
                </footer>
            </div>
