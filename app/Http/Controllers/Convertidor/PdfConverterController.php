...
class PdfConverterController extends Controller
{
    ...
    /**
     * Verificar si un PDF cumple con los requisitos VUCEM
     */
    public function verify(Request $request)
    {
        ...
        $uniqueId = uniqid();
        $inputFileName = $uniqueId . '_verify.pdf';
        ...
        try {
            ...
            // Verificar el archivo usando el servicio
            $verificacion = $this->converter->verifyPdfCompliance($inputPath);
            ...
            return response()->json([
                'valido' => false,
                'errores' => ['Error durante la verificación: ' . $e->getMessage()]
            ], 500);
        }
    }
